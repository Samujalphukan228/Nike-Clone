...
const Home = () => {
  return (
    <section className="">
      ...
      <div className="mt-20 ">
        ...
        <div className=" lg:flex lg:flex-wrap">
          <div className="lg:w-[50%] relative">
            ...
            />
            <div className="absolute bottom-5 left-6 z-10 text-white lg:bottom-16 ">
            
              <h2 className="text-lg font-semibold">Look of Football</h2>
              <h1 className="text-2xl lg:text-3xl font-bold">Total 90</h1>
          ...
          <div className="lg:w-[50%] relative">
            ...
            <div className="absolute bottom-5 left-6 z-10 text-white lg:bottom-16 ">
              ...
              <h1 className="text-2xl lg:text-3xl font-bold">Make a Impresson</h1>
              <button className="mt-4 font-medium text-lg bg-white text-black px-5 py-2 rounded-full">
                Shop LD-1000
              </button>
            </div>
          ...
          <div className="lg:w-[50%] relative">
            ...
            <div className="absolute bottom-5 left-6 z-10 text-white lg:bottom-16 ">
              ...
              <h1 className="text-2xl lg:text-3xl font-bold">Nike Star runner 5</h1>
              <button className="mt-4 font-medium text-lg bg-white text-black px-5 py-2 rounded-full">
                Shop
              </button>
            </div>
          ...
          <div className="lg:w-[50%] relative">
            ...
            <div className="absolute bottom-5 left-6 z-10 text-white lg:bottom-16 ">
              ...
              <h1 className="text-2xl lg:text-3xl font-bold">Air Jordan 40</h1>
              <button className="mt-4 font-medium text-lg bg-white text-black px-5 py-2 rounded-full">
                Get Notified
              </button>
            </div>
      ...
      <div className="px-6 mt-20"><div className="mb-10 border-gray-300   border-t-1"/>
      <Footer/>
      </div>
      <div className="flex gap-18 text-md font-medium justify-center text-gray-500 mt-20 mb-13">
